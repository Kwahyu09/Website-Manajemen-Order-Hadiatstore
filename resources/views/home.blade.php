...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar"
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4 active" href="#billboard">Utama</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link me-4" href="#company-services">Cara Order</a>
                            </li>
                            <li class="nav-item">
                                    ...
                                    <ul class="d-flex justify-content-end list-unstyled">
                                        <li>
                                            <a href="cart.html">
                                                <a href="/login">
                                                    @csrf
                                                    <i class="bi bi-box-arrow-down-left mr-3"> </i> Login
                                                </a>
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row d-flex flex-wrap align-items-center">
                            <div class="col-md-6">
                                <div class="banner-content">
                                    <h1 class="display-2 text-uppercase text-dark pb-5">Toko Buket Balon Bengkulu</h1>
                                    <a href="shop.html"
                                        class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Hadiat.store</a>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="image-holder">
    ...
    <section id="company-services" class="padding-large">
        <div class="container">
            <div class="row">
                <h1 class="text-center mb-5">Cara Order</h1>
                    ...
                    <div class="icon-box d-flex">
                        ...
                        <div class="icon-box-content">
                            ...
                            <ol>
                                ...
                                <li>
                                    <p>hubungi kontak admin yang ada dibawah ini</p>
                                </li>
                            </ol>
                        </div>
                    </div>
          ...
          <div class="content px-md-5">
              <div class="row">
                  <div class="col-12 col-lg-6 content-body">
                      <img src="/images/banner-image.png" alt="" class="w-100 rounded">
                  </div>
